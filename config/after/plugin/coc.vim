...
" select code *A*ction (a)
nmap ,ca :CocAction<CR>
" run code *L*ens (l)
nmap ,cl  <Plug>(coc-codelens-action)
" QuickFix problem on current line (qf)
...
augroup mygroup
  ...
  autocmd FileType typescript,json,haskell,rust setl formatexpr=CocAction('formatSelected')
